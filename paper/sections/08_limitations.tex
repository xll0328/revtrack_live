...
The mini60 agreement result should be interpreted narrowly: it is a bounded consistency check on hard cases, not a substitute for full two-annotator coverage across all packets.
