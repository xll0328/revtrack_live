...
The next step is therefore a non-ICLR random/stratified slice for broader prevalence-sensitive evidence, and a second annotator pass only if the paper claims inter-annotator reliability.
