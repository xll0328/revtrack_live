...
The practical failure mode is not just a wrong label: a model may repeat a concern that has been fixed, or credit a response that only defers the issue.
Both failures distort author effort and reviewer attention.
...
This is useful benchmark evidence because it shows where static matching breaks under pressure.
