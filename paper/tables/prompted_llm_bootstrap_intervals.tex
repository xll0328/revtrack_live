...
\bottomrule
\end{tabular}
\caption{Example-level bootstrap intervals for selected prompted LLM and vote baselines. Intervals capture sample instability only; they do not include annotator uncertainty or API stochasticity.}
\label{tab:prompted-llm-bootstrap}
\end{table*}
