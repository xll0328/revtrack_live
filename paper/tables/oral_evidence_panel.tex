...
\begin{tabular}{p{0.19\textwidth}p{0.47\textwidth}p{0.28\textwidth}}
\toprule
...
Readiness gate & overall\_status=ready ready\_claims=9 blockers=0 & Submission gate is satisfied for current scoped claims. \\
\bottomrule
\end{tabular}
\caption{Oral/rebuttal evidence panel built from current auditable artifacts.}
\label{tab:oral-evidence-panel}
\end{table*}
