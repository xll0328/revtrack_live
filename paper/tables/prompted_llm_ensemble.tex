...
\bottomrule
\end{tabular}
\caption{Macro-F1 of prompted LLMs and vote ensembles on three standard-labeled splits. Voting improves in-domain stability, but transfer on expanded80 remains brittle.}
