...
\bottomrule
\end{tabular}
\caption{Current RevTrack dataset and validation artifacts. Expanded80 and NeurIPS 2024 limit100 are user-confirmed active frontiers, while ICLR 2023 random80 is a user-confirmed random/stratified slice. None is a two-annotator agreement set or a venue-wide prevalence estimate.}
