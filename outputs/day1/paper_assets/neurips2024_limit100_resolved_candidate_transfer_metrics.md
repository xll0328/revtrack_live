# neurips2024_limit100_resolved_candidate Standard Transfer Metrics

These metrics use a validation sheet with status `assistant_resolved_candidate_user_review_required`. Report them only under that provenance boundary; this is not an independent two-annotator IAA result unless a separate IAA pass exists.
